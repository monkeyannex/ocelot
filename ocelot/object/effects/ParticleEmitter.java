...
public class ParticleEmitter extends GameObject{
    ...
    public ParticleEmitter(int iOBJECT_ID, String iNAME, String iTYPE, Engine iengine, Player iplayer) {
        ...
        for (int x = 0; x < PARTICLE_NUMBER; x++) {
            ...
            particles.add(new Rectangle2D.Double(POS_X, POS_Y, SIZE, SIZE));
    ...
    public void draw(Graphics2D g) {
        ...
        for (int x = 0; x < PARTICLE_NUMBER; x++) {
            ...
            double P_POS_X = POS_X + p[x][0] + (SPEED_X);
            double P_POS_Y = POS_Y + p[x][1] + (SPEED_Y);
